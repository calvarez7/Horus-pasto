...
class CreateEfectividadFarmacologicasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('efectividad_farmacologicas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('efectividad_farmacologicas');
    }
}
