    ...
    <div id="content">
        ...
        <div class="tg-wrap">
            ...
            <table class="tg">
                ...
                <tr>
                    <td class="tg-x6od">{{$medicamento['Codigo']}}</td>
                    ...
                    <td class="tg-x6od">@if (!empty($medicamento['Auth_Nota'])){{$medicamento['Auth_Nota']}} @endif</td>
                </tr>
                @endforeach
                <tr>
                    <td class="tg-37mw" colspan="8"><span style="font-weight:bold">IMPORTANTE</span>:
                        @if($numero == 1)
                        <span
                            style="font-style:italic">ESTE DOCUMENTO ES VÁLIDO SOLAMENTE HASTA EL {{ $Fecha_estimada }}, UNA VEZ
                            CUMPLIDO DICHO PLAZO NO HAY RESPONSABILIDAD DE LA EPS. </span><br><span>SUMIMEDICAL - RED VITAL
                        </span>
                        @else
                        <span
                            style="font-style:italic">ESTE DOCUMENTO ES VÁLIDO SOLAMENTE DESDE {{ $Fecha_inicio }} HASTA EL {{ $Fecha_estimada }}, UNA VEZ
                            CUMPLIDO DICHO PLAZO NO HAY RESPONSABILIDAD DE LA EPS. </span><br><span>SUMIMEDICAL - RED VITAL
                        </span>
                        @endif
                    </td>
