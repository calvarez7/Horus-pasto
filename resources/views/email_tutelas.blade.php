					...
					<tr>
						<td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									@if (isset($tutelaAlert))
										<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
											<P style="color: #FF0000; font-family: Arial, sans-serif; font-size: 24px;">URGENTE<p>
											<p>Buen día.</p>
											<p>Se le recuerda que tiene una tutela con id {{ $tutelaAlert }} y documento {{ $cedula }}.</p>
											<p style="color: #FF0000;">Pronta a vencer y requiere respuesta inmediata.</p>
											<p>Ingresar al modulo de tutelas <a href="http://www.horus-health.com/tutelas">Horus Health</a>.</p>
										</td>
									@else
										<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
											<p>Buen día.</p>
											<p>Se le ha asignado una tutela con id {{ $tutela }} y documento {{ $cedula->Num_Doc }}.</p>
											<p>Recuerde que esta tutela tiene un tiempo de cumplimiento.</p>
											<p>Ingresar al modulo de tutelas <a href="http://www.horus-health.com/tutelas">Horus Health</a>.</p>
										</td>
									@endif
								</tr>
