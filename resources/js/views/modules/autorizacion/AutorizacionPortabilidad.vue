    ...
    <v-card>
                            ...
                            <v-tab-item>
                                <v-card flat>
                                    ...
                                    <v-data-table class="fb-table-elem" :headers="diagnosticHeaders"
                                        :items="cie10sCita" item-key="index" hide-actions expand>
                                        <template v-slot:items="Diagnostico">
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="datatable-cell-wrapper">
                                                        <v-checkbox disabled color="primary" hide-details
                                                            v-model="Diagnostico.item.pivot.Esprimario"></v-checkbox>
                                                    </div>
                                                </td>
                                                <td class="text-xs-center">
                                                    <div class="datatable-cell-wrapper">
                                                        {{ Diagnostico.item.Codigo_CIE10 }} - {{ Diagnostico.item.Descripcion }}
                                                    </div>
                                                </td>
                                                <td class="text-xs-center">
                                                    <div class="datatable-cell-wrapper">
                                                        {{ Diagnostico.item.pivot.Tipodiagnostico }}</div>
                                                </td>
                                            </tr>
                                        </template>
                    ...
                    <v-card>
                        ...
                        <v-data-table class="fb-table-elem" :headers="cupOrderHeaders" :items="autorizacion.cupordens"
                            ...
                            <template v-slot:items="props">
                                ...
                                <td class="text-xs-center">
                                    <div class="datatable-cell-wrapper">{{ props.item.Servicio_Nombre }}</div>
                                </td>
                                <td class="text-xs-center">
        ...
        <v-data-table
            ...
            <template v-slot:items="props">
                ...
                <td class="text-xs-center">{{ props.item.citapaciente | diagnosticoFilter }}</td>
...
<script>
    ...
    export default {
        ...
        filters:{
            diagnosticoFilter(citaPaciente){
                let diagnostico = '';
                citaPaciente.cie10s.forEach(cie => {
                    diagnostico += diagnostico? `, ${cie.Codigo_CIE10} - ${cie.Descripcion}` : `${cie.Codigo_CIE10} - ${cie.Descripcion}`;
                })
        ...
        methods: {
            ...
            abrirModal(autorizacion) {
                ...
                this.cie10sCita = autorizacion.citapaciente.cie10s;
            ...
            getObjHistorial(autorizacion) {
                ...
                return (this.object = {
                    ...
                    Diagnostico_Secundario: object.Diagnostico_Secundario,
            ...
            find() {
                ...
                axios.post("/api/autorizacion/getOrdenesPortabilidad", data)
                    .then(res => {
