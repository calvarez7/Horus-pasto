    ...
    <v-card>
        ...
        <v-dialog v-model="dialogFilter" scrollable max-width="900px">
            <v-card>
                <v-list two-line subheader>
                    <v-list-tile v-for="item in resultadoFiltro.principales" :key="item.id"
                        ...
                        <v-list-tile-content>
                            ...
                            <v-list-tile-sub-title>{{ item.ruta.replace('adjuntos_intranet','Documentos') }}
                ...
                <v-toolbar-items class="white--text">
                    <v-breadcrumbs :items="items">
                        <template v-slot:item="props">
                            <a style="color:#fff"
                                @click="carpetaMiga(props.item.id,props.item.ruta,props.item.text,props.item.tipo)">{{ props.item.text.toUpperCase() }}</a>
                        </template>
                    </v-breadcrumbs>
                </v-toolbar-items>
            </v-toolbar>
        ...
        <v-card-text class="mt-4 mb-4">
            <v-container grid-list-xl text-xs-center>
                <v-layout row wrap>
                    <v-flex v-for="i in carpetas" md2 sm2 xs12 class="mb-5"
                        @click="mostarsubcarpeta(i.id,i.ruta,i.nombre)" :key="i">
                        <v-card class="mb-5">
                            <div class="folder">
                    ...
                    <v-flex v-for="i in subCarpetas" md2 sm2 xs12 class="mb-5"
                        @click="mostarSubcarpetaEnSubcarpeta(i.id,i.ruta,i.nombre)" :key="i">
                        <v-card class="mb-5">
                            <div class="folder">
                                <div class="paper one"></div>
                                <div class="paper two"></div>
                    ...
                    <v-flex v-for="i in subCarpetas2" md2 sm2 xs12 class="mb-5"
                        @click="mostarSubcarpetaEnSubcarpeta(i.id,i.ruta,i.nombre)" :key="i">
                        <v-card class="mb-5">
                            <div class="folder">
                                <div class="paper one"></div>
    ...
    export default {
        ...
        methods: {
            ...
            guardarCarpeta() {
                this.preload = true;
                if (this.nivel === 1) {
                    axios.post("api/intranet/carpeta", {
