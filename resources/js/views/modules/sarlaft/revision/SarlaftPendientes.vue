<template>
    <div>
            ...
            <v-card>
                <form @submit.prevent="guardarRevision">
                    ...
                    <v-card-text>
                        ...
                        <v-layout wrap v-if="historicoRevision != null">
                            <v-flex xs12>
                                ...
                                <v-spacer></v-spacer>
                                <v-flex xs12 v-for="(data, index) in historicoRevision.adjuntos" :key="adjuntos.revision_sarlafts_id">
                    ...
                    <v-card-actions>
                        ...
                        <v-btn color="red lighten-2" dark @click="updateRevsion()">Terminar revision</v-btn>
                    </v-card-actions>
                </form>
            </v-card>
        </v-dialog>
        <v-tabs centered color="primary" dark icons-and-text>
            ...
            <v-tab href="#tab-1" @click="all('Vinculacion Primera Vez')">
                Vinculacion Primera Vez
                <v-icon>account_box</v-icon>
            </v-tab>

            <v-tab href="#tab-2" @click="all('Actualizacion Novedad')">
                Actualizacion Novedad
                <v-icon>account_box</v-icon>
            </v-tab>

            <v-tab href="#tab-3" @click="all('Actualizacion Anual')">
                Actualizacion Anual
                <v-icon>account_box</v-icon>
            </v-tab>
...
<script>
    export default {
        ...
        methods: {
            ...
            all(tipo = "Vinculacion Primera Vez") {
                axios.get('/api/sarlaft/all/' + tipo).then(res => {
