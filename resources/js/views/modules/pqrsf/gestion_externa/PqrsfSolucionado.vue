    ...
    <div>
        <v-card>
            <v-card-title>
                ...
                <v-combobox :items="['Web', 'Supersalud']" label="Canal" single-line hide-details v-model="canal"></v-combobox>
                <v-spacer></v-spacer>
                 <v-text-field v-model="search" prepend-icon="search" label="Buscar" single-line hide-details
                    persistent-hint v-on:keyup.enter="getSolvedFilter()"></v-text-field>
            </v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            getSolvedFilter() {
                ...
                axios.post('/api/pqrsf/solved', this.data)
                    .then(res => {
                        this.loading = false
