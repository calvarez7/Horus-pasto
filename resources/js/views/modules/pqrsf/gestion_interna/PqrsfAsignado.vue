                                ...
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs12 v-if="pqrsfSubcategorias.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrsfSubcategorias" :key="`sb-${index}`">
                                    ...
                                    <v-flex xs12 v-if="pqrsfDetallearticulo.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrsfDetallearticulo" :key="`mei-${index}`">
                                                <v-chip label :selected="data.selected">
                                                    {{data.Producto}}
                                                </v-chip>
                                            </v-item>
                                    ...
                                    <v-flex xs12 v-if="pqrsfcups.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrsfcups" :key="`sev-${index}`">
                                                <v-chip label :selected="data.selected">
                                                    {{data.Nombre}}
                                                </v-chip>
                                            </v-item>
                                    ...
                                    <v-flex xs12 v-if="pqrareas.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrareas" :key="`re-${index}`">
                                                <v-chip label :selected="data.selected">
                                                    {{data.Nombre}}
                                                </v-chip>
                                            </v-item>
                                    ...
                                    <v-flex xs12 v-if="pqrips.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrips" :key="`ip-${index}`">
                                                <v-chip label :selected="data.selected">
                                                    {{data.Nombre}}
                                                </v-chip>
                                            </v-item>
                                    ...
                                    <v-flex xs12 v-if="pqrempleados.length > 0">
                                        ...
                                        <v-item-group multiple>
                                            <v-item v-for="(data, index) in pqrempleados" :key="`ep-${index}`">
                                                <v-chip label :selected="data.selected">
                                                    {{data.Nombre}}
                                                </v-chip>
                                            </v-item>
                                    ...
                                    <v-flex xs12 v-for="(GesPqr, index) in pqrsf.gestion_pqrsfs" :key="`ad-${index}`">
                                        <v-flex v-if="GesPqr.Tipo_id == 3">
                                            <v-flex xs12 md12 v-if="GesPqr.name">
                                                <span> <strong>Nombre:</strong> {{ GesPqr.name }}
                                                    {{ GesPqr.apellido }}</span>
                                            </v-flex>
                                            <v-btn v-for="(data, index) in GesPqr.adjuntos_pqrsf" :key="`aj1-${index}`">
    ...
    export default {
        ...
        methods: {
            ...
            getAssignedFilter() {
                ...
                this.loading = true;
                axios.post('/api/pqrsf/assignedInterna')
                    .then(res => {
                        this.loading = false
