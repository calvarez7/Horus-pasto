...
export default {
  ...
  methods: {
    ...
    getPresolutionFilter() {
      ...
      this.loading = true;
      axios.post("/api/pqrsf/pre_solutionInterna").then((res) => {
        this.loading = false;
    ...
    remove_subcategoria(item) {
      ...
      saveSubcategories(pqrsf) {
        if (this.pqrsfSubcategorias == '') {
                ...
                axios.post(`/api/pqrsf/actualizarSubcategoria/${pqrsf.id}`, formData).then(res => {
        ...
        saveAreas(pqrsf) {
                ...
                axios.post(`/api/pqrsf/ActualizarAreas/${pqrsf.id}`, formData).then(res => {
                    this.areas = ''
