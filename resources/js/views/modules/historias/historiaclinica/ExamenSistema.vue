            ...
            <v-stepper v-model="e6" vertical>
                ...
                <v-stepper-content step="3">
                    <v-container grid-list-xs>
                        ...
                        <v-layout row wrap>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.a" label="Cabeza Cuello"></v-switch>
                                <v-text-field label="Cabeza Cuello" v-show="data.a" v-model="data.Cabezacuello">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.b" label="Ojos y Fondo de Ojos"></v-switch>
                                <v-text-field label="Ojos y Fondo de Ojos" v-show="data.b" v-model="data.Ojosfondojos">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.c" label="Agudeza Visual"></v-switch>
                                <v-text-field label="Agudeza Visual" v-show="data.c" v-model="data.Agudezavisual">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.d" label="Cardiopulmonar"></v-switch>
                                <v-text-field label="Cardiopulmonar" v-show="data.d" v-model="data.Cardiopulmonar">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.e" label="Abdomen"></v-switch>
                                <v-text-field label="Abdomen" v-show="data.e" v-model="data.Abdomen"></v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.f" label="Osteomuscular"></v-switch>
                                <v-text-field label="Osteomuscular" v-show="data.f" v-model="data.Osteomuscular">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.g" label="Extreminades"></v-switch>
                                <v-text-field label="Extreminades" v-show="data.g" v-model="data.Extremidades">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.h" label="Pulsos Periféricos"></v-switch>
                                <v-text-field label="Pulsos Periféricos" v-show="data.h"
                                    v-model="data.Pulsosperifericos"></v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.i" label="Neurológicos"></v-switch>
                                <v-text-field label="Neurológicos" v-show="data.i" v-model="data.Neurologico">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.j" label="Reflejos Osteotendinosos"></v-switch>
                                <v-text-field label="Reflejos Osteotendinosos" v-show="data.j"
                                    v-model="data.Reflejososteotendinos"></v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.k" label="Piel y Faneras"></v-switch>
                                <v-text-field label="Piel y Faneras" v-show="data.k" v-model="data.Pielfraneras">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.l" label="Genitourinario"></v-switch>
                                <v-text-field label="Genitourinario" v-show="data.l" v-model="data.Genitourinario">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.o" label="Examen de Mama"></v-switch>
                                <v-text-field label="Examen de Mama" v-show="data.o" v-model="data.Examenmama">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.p" label="Tacto Rectal"></v-switch>
                                <v-text-field label="Tacto Rectal" v-show="data.p" v-model="data.Tactoretal">
                                </v-text-field>
                            </v-flex>
                            <v-flex xs4 px-1>
                                <v-switch color="primary" v-model="data.q" label="Examen Mental"></v-switch>
                                <v-text-field label="Examen Mental" v-show="data.q" v-model="data.Examenmental">
                                </v-text-field>
                            </v-flex>
                        </v-layout>
                    </v-container>
    ...
    export default {
        ...
        methods: {
            ...
            async  calcularIMC() {
                ...
                if (this.paciente.Edad_Cumplida > 5) {
