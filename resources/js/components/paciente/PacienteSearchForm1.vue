    ...
    export default {
        ...
        methods:{
            search_paciente(){
                ...
                axios.get(`/api/paciente/showEnabled/${this.cedula_paciente}`).then((res) => {
                        if (res.data.paciente) {
                        axios.get('/api/entidades/validar/'+res.data.paciente.entidad_id+'/atender_paciente').then(res2 => {
                            if(res2.data.acceso){
