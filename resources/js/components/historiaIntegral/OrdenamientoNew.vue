<template>
    <v-container style="max-width: 12000px;">
        ...
        <v-card>
            <v-container grid-list-xs>
                <v-layout row wrap>
                    ...
                    <template v-if="data.Tiporden_id == 9">
                        <v-flex xs12 lg12 v-if="paciente.Ut === 'REDVITAL UT'">
                            <VAutocomplete label="Escoger tipo de recomendacion:"
                                :items="['Recomendaciones','Carta de Aislamiento']" v-model="recomendaciones.tipo" />
                        </v-flex>
                        <v-flex xs12 v-if="recomendaciones.tipo === 'Recomendaciones'">
                            <v-card>
                                <v-card-text>
                                    <v-container grid-list-md>
                                        <v-layout row wrap>
                                            <v-flex xs12>
                                                ...
                                                <v-textarea v-model="
                                                        recomendaciones.recomedacion" />
                                            </v-flex>
                                        </v-layout>
                                    </v-container>
                                </v-card-text>
                                <v-card-actions>
                                    <v-btn color="primary" round @click="generateRecomendacion()">Generar</v-btn>
                                </v-card-actions>
                            </v-card>
                        </v-flex>
                        <v-flex xs12 v-if="recomendaciones.tipo === 'Carta de Aislamiento'">
                            <v-card>
                                <v-card-text>
                                    <v-container grid-list-md>
                                        <v-layout row wrap>
                                            <v-flex xs12>
                                                <v-card-title class="headline" style="color:black">
                                                    <span>Carta de Aislamiento</span>
                                                </v-card-title>
                                            </v-flex>
                                            <v-flex xs4>
                                                <VTextField label="Fecha de terminacion de aislamiento" type='date'
                                                    v-model="
                                                        recomendaciones.FechaFinal
                                                    " required />
                                            </v-flex>
                                        </v-layout>
                                    </v-container>
                    ...
                    <template v-if="data.Tiporden_id == 8">
                        <v-flex xs12>
                            <v-card>
                                ...
                                <v-card-actions>
                                    <v-btn color="primary" round @click="generateOptometria()">Generar</v-btn>
                                </v-card-actions>
                    ...
                    <template v-if="data.Tiporden_id == 3">
                                        ...
                                        <v-data-table :headers="headersHistoricoMedicamentos" :items="historicoOrdens"
                                            ...
                                            <template v-slot:items="props">
                                                ...
                                                <td class="text-xs-center"
                                                    ...
                                                    <v-chip
                                                        @click="abrirModalNegaciones(props.item.detaarticulordens_id)"
                                                        color="red" text-color="white">{{ props.item.Estado }}</v-chip>
                                                </td>
                                                <td class="text-xs-center" v-if="props.item.EstadosOrden == 50">
                                                    <v-chip
                                                        @click="abrirModalSuspenciones(props.item.detaarticulordens_id)"
                                                ...
                                                <td v-show="props.item.EstadosOrden == 1 || props.item.EstadosOrden == 7 "
                                                    class="text-xs-center">
                                                    <v-btn fab small color="warning"
                                                        @click="abrirModalSuspender(props.item)">
                                                        <v-icon>mdi-message-alert</v-icon>
                                                    </v-btn>
                                                </td>
                                                <td class="text-xs-center"
                                                    v-show="props.item.EstadosOrden == 17 || props.item.EstadosOrden == 24 || props.item.EstadosOrden == 25 || props.item.EstadosOrden == 26 || props.item.EstadosOrden == 50">
                                                ...
                                                <td class="text-xs-center">
                                                    <v-btn fab small color="info"
                                                        @click="conciliarMedicamento(props.item)">
                        ...
                        <v-flex 22>
                            <v-layout row wrap>
                                <v-flex xs9>
                                    <v-autocomplete label="Medicamento" :items="filteredMedicamentos" item-text="Nombre"
                                        v-model="articulos.medicamento" return-object @change="validar()">
                                        <template v-slot:item="data">
                                            <template>
                                                {{data.item.Nombre}}
                                                <v-icon v-if="data.item.color == 'LASA - AMARILLO'" large
                                                    color="yellow">mdi-pill</v-icon>
                                                <v-icon v-else-if="data.item.color == 'LASA - VERDE'" large
                                                    color="green">mdi-pill</v-icon>
                                                <v-icon v-else-if="data.item.color == 'MAXIMA ALERTA'" large
                                                    color="red">mdi-pill</v-icon>
                                                <v-icon v-else-if="data.item.color == 'LASA-AZUL'" large color="blue">
                                                    mdi-pill</v-icon>
                                            </template>
                                        </template>
                            ...
                            <v-btn color="success" round @click="fecthAlertas()">Agregar</v-btn>
                    ...
                    <template v-if="data.Tiporden_id == 2 || data.Tiporden_id == 4">
                        <v-flex xs12>
                            <v-layout row wrap>
                                ...
                                <v-flex xs12>
                                    <v-autocomplete label="Paquete Servicios" item-text="nombre" :items="listaPaquetes"
                                        v-model="procedimiento.paquete" return-object></v-autocomplete>
                                </v-flex>
                                <v-flex xs2>
                            ...
                            <v-btn color="warning" round @click="agregarPaquete()">Agregar Paquete</v-btn>
                        </v-flex>
                    </template>
                ...
                <v-layout row wrap v-show="data.Tiporden_id != 1">
                    ...
                    <v-layout row wrap v-if="data.Tiporden_id != 8 && data.Tiporden_id != 9">
                        <VSpacer />
        ...
        <v-flex pt-2>
                ...
                <v-container grid-list-xs>
                    <v-layout row wrap>
                        <v-flex xs12>
                            ...
                            <!--tipo orden 8-->
                            <v-data-table v-show="data.Tiporden_id == 8" :headers="headersOptometriaOrdered"
                                :items="fetchOptometria" hide-actions class="elevation-1" pagination.sync="pagination"
                                item-key="id" loading="true">
                                <template v-slot:items="props">
                                    <td class="text-xs-center"> {{ props.item.id }} </td>
                                    <td class="text-xs-center"> {{ props.item.tipo_lente }} </td>
                                    <td class="text-xs-center"> {{ props.item.Observacion }} </td>
                                    <td class="text-xs-center"> {{ props.item.control }} </td>
                                    <td class="text-xs-center"> {{ props.item.dp }} </td>
                                    <td class="text-xs-center"> {{ props.item.created_at.substring( 0, 10 ) }} </td>
                                </template>
                            </v-data-table>
                            <!--tipo orden 9-->
                            <v-data-table v-show="data.Tiporden_id == 9" :headers="headersRecomendaciones"
                                :items="fetchRecomendacion" hide-actions class="elevation-1"
                                pagination.sync="pagination" item-key="id" loading="true">
                                <template v-slot:items="props">
                                    <td class="text-xs-center"> {{ props.item.id }} </td>
                                    <td class="text-xs-center"> {{ props.item.recomedacion }} </td>
                                    <td class="text-xs-center"> {{ props.item.fecha_aislamiento }} </td>
                                    <td class="text-xs-center"> {{ props.item.created_at.substring( 0, 10 ) }} </td>
                                </template>
                            </v-data-table>
                        </v-flex>
            ...
            <v-dialog v-model="dialogAlertaNoInteracciones" persistent max-width="1200">
                <v-card>
                    <v-card-title class="headline" style="color: white; background-color: #0074a6;"> <span
                            class="title layout justify-center font-weight-light">ALERTAS
                            FARMACOLOGICAS INFORMATIVAS</span>
                    </v-card-title>
                    <v-container fluid grid-list-md>
                        <v-data-iterator :items="alertasFarmacologicasNoInteracciones" content-tag="v-layout" row wrap>
                            <template v-slot:item="props">
                                <v-flex xs12>
                                    <v-card>
                                        <v-card-title class="headline justify-center"
                                            style="color:black;background-color:#f0f2f2">
                                            <h3>{{props.item.Nombre_Alerta}} </h3>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="success darken-1" dark
                            @click="addArticulo(), dialogAlertaNoInteracciones = false">
                            Continuar</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
            <v-dialog v-model="dialogAlertaInteracciones" persistent max-width="1200">
                <v-card>
                    <v-card-title class="headline" style="color: white; background-color: #0074a6;"> <span
                            class="title layout justify-center font-weight-light">ALERTAS
                            FARMACOLOGICAS INTERACCIONES</span>
                    </v-card-title>
                    <v-container fluid grid-list-md>
                        <v-data-iterator :items="alertasFarmacologicasInteracciones" content-tag="v-layout" row wrap>
                            <template v-slot:item="props">
                                <v-flex xs12>
                                    <v-card>
                                        <v-card-title class="headline justify-center"
                                        ...
                                        <v-flex>
                                            <h3>
                                                {{props.item.interaccion}} : {{ props.item.Mensaje }} </h3>
                                            <v-flex text-xs-center>
                                                <v-btn color="info darken-1" dark
                                                    @click="confirmacionAlerta(props.item, 'Si')">
                                                    Aceptar
                                                </v-btn>
                                                <v-btn color="error darken-1" dark
                                                    @click="confirmacionAlerta(props.item, 'No')">
                                                    Rechazar
                                                </v-btn>
                                            </v-flex>
                                        </v-flex>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn color="success" dark
                            @click="fecthAlertasNoInteracciones(), dialogAlertaInteracciones = false">
                            Continuar</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
        </v-flex>
        <v-dialog v-model="modal.firma" max-width="1200px" persistent>
            <FirmaConsentimientoComponent :cita_paciente_id="datosCita.cita_paciente_id" :cup_id="cups_consentimiento_id"
                @submit="printConsentimientosInformados(), clearData(), modal.firma = false" />
        </v-dialog>

    </v-container>
</template>
<script>
    import FirmaConsentimientoComponent from "./FirmaConsentimientoComponent.vue"
    ...
    export default {
        ...
        data: () => ({
            ...
            dialogAlertaNoInteracciones: false,
            dialogAlertaInteracciones: false,
            motivo: [],
            orden: [],
            compoM: null,
        ...
        methods: {
            addArticulo: async function () {
                ...
                if (this.articulos.medicamento.hasOwnProperty("id") && this.articulos.Cantidadosis && this.articulos
                    ...
                    if (medicamento) {
                        let msg =
                            `Existen Ordenes activas para éste medicamento por la cantidad ${medicamento.Cantidadpormedico} en la siguiente fecha ${medicamento.Fechaorden}. La cantidad máxima es de ${medicamento.Cantidadmaxordenar}`;
                        swal({
                            title: "Error",
                            text: msg,
                            type: "success",
                    ...
                    return this.$alerError("Todos los campos deben estar llenos");
                }
            },
            ...
            generateOrder: async function () {
                ...
                if (this.data.Tiporden_id == 8 && this.data.optometria.length === 0) {
                    return this.$alerError("No hay Formula para ordenar");
                }
                swal({
                    title: "¿Está Seguro(a)?",
                        ...
                        axios.post(`/api/orden/citapaciente/${this.cita_paciente}/create`, {
                            ...
                            if (this.data.Tiporden_id == 3) {
                                ...
                                this.data.procedimientos.forEach((ser)=>{
                                    axios.post('/api/recomendacion-cup/getRecomendacion', ser).then((res) => {
                                        if(res.data.respuesta = true){
                                            let pdf = {
                                                type: "recomendacionOrdenCup",
                                                id: ser.id,
                                ...
                                this.data.procedimientos.forEach((ser) => {
                                    axios.post('/api/orden/verificacionConsentimiento', ser)
                                        .then((res) => {
                                            if (res.data.consentimientoInformado == true) {
                                                this.cups_consentimiento_id = res.data.id
                                                swal({
                                                    title: "Autorizacion de firma electronica",
                                                    ...
                                                    if (willDelete) {
                                                        this.modal.firma = true;
                                                    } else {
                                                        this.printConsentimientosInformados();
                                                        this.clearData();
                                                    }
                                                });
                                            }else{
            ...
            getFinalDate() {
                        ...
                        if (willDelete) {
                            ...
                            axios.post(
                                ...
                                if (this.data.Tiporden_id == 3) {
                                    ...
                                    this.fetchCupsOrdered();
                                    // this.modal.firma = true;
                                    //this.printConsentimientosInformados(this.data.procedimientos);
                                }
                                //this.clearData();
                                if (res.data.ubicaciones) {
                                    this.ubicaciones = res.data.ubicaciones;
                ...
                if (this.incapacidad.Contingencia != "licencia maternidad" && this.incapacidad
                    .CantidadDias > 30) {
                    swal({
                        title: "Incapacidad",
                ...
                if (this.enable == true) {
                    this.incapacidad.FechaFinal = moment(this.incapacidad.FechaInicio).add(this
                        .incapacidad
            ...
            getCupOrden: async function () {
                ...
                this.cupsOrdered.forEach((procedimiento) => {
                    if (procedimiento.Estado_id == 37 && procedimiento
                        .created_at.substring(0, 10) ==
                        moment().format("YYYY-MM-DD")) {
                        this.serviciosAnexo.push(procedimiento);
                    } else if (procedimiento.Estado_id != 15 && procedimiento
                        .created_at.substring(0, 10) ==
                        moment().format("YYYY-MM-DD")) {
            ...
            getConducta() {
                axios.post(
                    `/api/conducta/${this.datosCita.cita_paciente_id}/getConductaByCita`
                ).then((res) => {
            ...
            getDetaMedicamentos: async function (articulo) {
                ...
                await axios.post("/api/orden/getDetaArticuloOrden", {
                    ...
                    if (medicamento) {
                        ...
                        medicamento.Cantidadpormedico = res.data.reduce(
                            reducer, 0);
                    }
                });
                return medicamento;
            ...
            getDetaServicios: async function (service) {
                ...
                await axios.post("/api/orden/getCupOrden", {
                    ...
                    if (procedimiento) {
                        ...
                        procedimiento.Cantidad = res.data.reduce(
                            reducer, 0);
                    }
                });
            ...
            getDetaServiciosPropios: async function (service) {
                ...
                await axios.post("/api/orden/getServicioPropio", {
                    ...
                    if (servicioPropio) {
                        ...
                        servicioPropio.Cantidad = res.data.reduce(
                            reducer, 0);
                    }
                });
            ...
            printPDF: async function () {
                if (this.articulosOrdered.length == 0 && this
                    .cupsOrdered.length == 0 && this.servicioPropio
                    ...
                    return;
                } else if (this.data.Tiporden_id == 1 && this
                    .incapacidadOrdered.length == 0) {
                    swal({
                        title: "Impresión",
                    ...
                    return;
                } else if (this.data.Tiporden_id == 8 && this
                    .fetchOptometria.length == 0) {
                    swal({
                        title: "Impresión",
                        text: "No se encuentran formulas que imprimir",
                        icon: "warning",
                    });
                    return;
                    ...
                    switch (this.data.Tiporden_id) {
                        ...
                        case 3:
                            await axios.get(
                                    `/api/orden/getOrderedCodesumi/${this.datosCita.cita_paciente_id}`
                                )
                                .then((res) => {
                                    res.data.forEach((data) => {
                                        let obj = {
                        ...
                        case 4:
                            ...
                            for (const p in printPagesCup) {
                                this.serviciosByNo = printPagesCup[
                                    p];
                            ...
                            break;
                        case 6:
                            if (this.servicioPropioByNo.length ==
                                0) {
                                swal({
                                    title: "Impresión",
                                    text: "Se generó la orden pero los servicios requieren auditoria o no estan vigentes",
                            ...
                            this.servicioPropioByNo.forEach((
                                ser) => {
                                if (!printPagesService
                                    .hasOwnProperty(ser
                                        .Ubicacion_id))
                                    printPagesService[
                                        ser.Ubicacion_id
                                    ] = [];
                                printPagesService[ser
                                    .Ubicacion_id].push(
                                    ser);
                            });
                            ...
                            break;
                        case 8:
                            this.fetchOptometria.forEach((ser) => {
                                let pdf = {
                                    type: "optometriaOrden",
                                    id: ser.id,
                                };
                                this.printOptometria(pdf);
                            })
                            break;
                        case 9:
                            this.fetchRecomendacion.forEach((
                                ser) => {
                                let pdf = {
                                    type: "recomendacionOrden",
                                    id: ser.id,
                                };
                                this.printRecomendacion(
                                    pdf);
                            })
                            break;
            ...
            pushProcedimiento(cantidad = 0) {
                if (parseInt(this.procedimiento.cup
                        .Cantidadmaxordenar) >= parseInt(this
                        .procedimiento.cantidad) +
                    parseInt(cantidad)) {
                    this.data.procedimientos.push({
                        id: this.procedimiento.cup.id,
                        codigo: this.procedimiento.cup
                            .Codigo,
                        nombre: this.procedimiento.cup
                            .Nombre,
                        auditoria: this.procedimiento.cup
                            .Requiere_auditoria,
                        cantidad: this.procedimiento
                            .cantidad,
                        observacion: this.procedimiento
                            .observacion,
            ...
            pushServicioPropio(cantidad = 0) {
                if (parseInt(this.servicioPropio.service
                        .Cantidadmaxordenar) >= parseInt(this
                        .servicioPropio.cantidad) +
                    parseInt(cantidad)) {
                    this.data.serviciosPropios.push({
                        id: this.servicioPropio.service.id,
                        codigo: this.servicioPropio.service
                            .Codigo,
                        nombre: this.servicioPropio.service
                            .Nombre,
                        auditoria: this.servicioPropio
                            .service.Requiere_autorizacion,
                        nivelordenamiento: this
                            .servicioPropio.service
                            .Nivel_ordenamiento,
                        cantidad: this.servicioPropio
                            .cantidad,
                        observacion: this.servicioPropio
                            .observacion,
                    });
            ...
            removeProcedimiento(procedimientos) {
                this.data.procedimientos.splice(procedimientos
                    .index, 1);
            },
            removeServicioPropio(servicioPropio) {
                this.data.serviciosPropios.splice(servicioPropio
                    .index, 1);
            },
            separateByAutorization: async function () {
                if (this.data.Tiporden_id == 2 || this.data
                    .Tiporden_id == 4) await this.getCupOrden();
                if (this.data.Tiporden_id == 3) await this
                    .getDetaArticulo();
                if (this.data.Tiporden_id == 6) await this
                    .getServicioPropio();
            },
            setUbicacion() {
                let ubicacion = " ";
                if (this.ubicaciones) {
                    this.data.procedimientos.map((
                        procedimiento) => {
                        let object = this.ubicaciones
                            .find((ubicacion) =>
                                ubicacion
                                .tarifacup_id ==
                                procedimiento.id);
                        procedimiento.cantidad =
                            procedimiento.cantidad;
                        procedimiento.id = procedimiento
                            .id;
            ...
            toggleAll() {
                if (this.data.codeSumiEsquemaSelected.length)
                    this.data.codeSumiEsquemaSelected = [];
                else this.data.codeSumiEsquemaSelected = this
                    .codeSumiEsquema.slice();
            },
            tipoOrdenSelected: async function () {
                switch (this.data.Tiporden_id) {
                    case 1:
                        if (this.paciente.tipo_categoria !=
                            'SUBSIDIADO' && this.paciente
                            .Tipo_Afiliado !=
                            'BENEFICIARIO') {
                            this.fetchIncOrdenred();
                        } else {
                            this.$alerError(
                                "El paciente es BENEFICIARIO o SUBSIDIADO, No se le puede realizar la incapacidad"
                            );
                        }
                    ...
                    case 3:
                        await this
                            .fetchMedicamentosOrdered();
                        this.fetchMedicamentos();
                        this.historicoCodesumi();
                        break;
                    case 4:
                        this.listarPaquetes();
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        this.fetchOptometriaOrden();
                    case 9:
                        this.fetchRecomendacionOrden();
                    default:
                        break;
                }
            },
            imprimirRecomendacion(codigo) {
                axios.get("/api/orden/recomendaciones/" +
                    codigo).then((res) => {
                    if (res.data.file.length > 0) {
                        res.data.file.forEach((
                            s) => {
                            const a =
                                document
                                .createElement(
            ...
            datosPacienteOrdenamiento() {
                axios.post('/api/historia/datosPaciente',
                    this.datosCita).then((res) => {
            ...
            historicoOrdenes(items) {
                ...
                axios.post('/api/historia/historicoOrdenes',
                    items).then((res) => {
            ...
            historicoCodesumi() {
                this.preload_datos = true
                axios.post(
                    '/api/historia/historicoMedicamentos',
                    this.datosCita).then((res) => {
                    this.historicoMedicamentos = res
                        .data;
                    this.preload_datos = false
                });
            },
            ...
            suspenderMedicamento() {
                this.dialogSuspender = true
                axios.post(
                    '/api/historia/suspenderMedicamento',
                    this.orden).then((res) => {
                    this.$alerSuccess(
                        'Suspendido con Exito');
            ...
            abrirModalNegaciones(items) {
                ...
                axios.get('/api/historia/motivoNegacion/' +
                    items).then((res) => {
            ...
            conciliarMedicamento(items) {
                ...
                this.articulos.medicamento = {
                    id: items.id,
                    Nombre: items.medicamentos,
                    Requiere_autorizacion: items
                        .Requiere_autorizacion,
                    Frecuencia: items.Frecuencia,
                    Cantidadmaxordenar: items
                        .Cantidadmaxordenar,
                    descripcion_atc: items
                        .descripcion_atc
                }
            },

            fecthAlertas() {
                if (this.articulos.medicamento
                    .hasOwnProperty("id") && this.articulos
                    .Cantidadosis && this
                    .articulos
                    .Unidadmedida && this.articulos.Via &&
                    this.articulos.Unidadtiempo &&
                    this.articulos
                    .Cantidadmensual && this.articulos
                    .NumMeses && this.articulos
                    .Cantidadpormedico) {
                    this.preload_datos = true
                    this.articulos.paciente_id = this
                        .paciente.id
                    axios.post('/api/orden/fecthAlergico',
                        this.articulos).then((res) => {
                        this.alergicoMedicamento =
                            res.data
                        if (this
                            .alergicoMedicamento !=
                            false) {
                            this.$alerError(
                                "El paciente es alérgico a este medicamento, por tal motivo no se va a dejar ordenar, Observacion: " +
                                this
                                .alergicoMedicamento
                                .observacionAlergia
                            );
                            ...
                            axios.post(
                                    '/api/orden/fecthdesabastesimiento',
                                    this.articulos)
                                .then((res) => {
                                    this.desabastesimientoMedicamento =
                                        res.data
                                    if (this
                                        .desabastesimientoMedicamento !=
                                        false) {
                                        this.$alerError(
                                            this
                                            .desabastesimientoMedicamento
                                        ...
                                        axios
                                            ...
                                            .then(
                                                (
                                                    ...
                                                    this.alertasFarmacologicasInteracciones =
                                                        res
                                                        .data
                                                        .mensajeInteracciones;
                                                    this.alertasFarmacologicasNoInteracciones =
                                                        res
                                                        .data
                                                        .mensajeNoInteracciones;
                                                    this.preload_datos =
                                                        false
                                                    if (this
                                                        .alertasFarmacologicasInteracciones !=
                                                        ...
                                                        this.dialogAlertaInteracciones =
                                                            true
                                                    } else if (
                                                        this
                                                        .alertasFarmacologicasNoInteracciones !=
                                                        ...
                                                        this.dialogAlertaNoInteracciones =
                                                            true
                                                    } else {
                                                        this
                                                            .addArticulo();
                    ...
                    swal({
                        title: "Verificar Campos de formulacion",
            ...
            fecthAlertasNoInteracciones() {
                this.preload_datos = true
                axios.post('/api/orden/fecthAlertas', this
                    .articulos).then((res) => {
                    this.alertasFarmacologicasNoInteracciones =
                        res.data
                        .mensajeNoInteracciones;
            ...
            confirmacionAlerta(items, tipo) {
                let confirmacion = []
                confirmacion = items
                confirmacion.paciente_id = this.paciente.id
                confirmacion.cita_paciente_id = this
                    .datosCita.cita_paciente_id
                confirmacion.tipo = tipo
                this.preload_datos = true
                axios.post('/api/orden/confirmacionAlerta',
                    confirmacion).then((res) => {
                    this.preload_datos = false
            ...
            generateOptometria() {
                if (this.optometria.esfera_od == "") {
                    swal({
                        title: "Formula de Optometria",
                        text: "Por favor ingrese una Esfera Derecha!",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                if (this.optometria.esfera_oi == "") {
                    swal({
                        title: "Formula de Optometria",
                        text: "Por favor ingrese una Esfera Izquierda!",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                if (this.optometria.dp == "") {
                    swal({
                        title: "Formula de Optometria",
                        text: "Por favor ingrese una Distancia Pupilar",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                if (this.optometria.control == "") {
                    swal({
                        title: "Formula de Optometria",
                        text: "Por favor ingrese un control",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                if (this.optometria.tipo_lente == "") {
                    swal({
                        title: "Formula de Optometria",
                        text: "Por favor ingrese un tipo de lente",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                swal({
                    title: "¿Está Seguro(a)?",
                    text: "Se guardará la formual de optometria!",
                    type: "success",
                    icon: "info",
                    buttons: ["Cancelar",
                        "Confirmar"
                    ...
                    if (willDelete) {
                        ...
                        await axios.post(
                            `/api/orden/citapaciente/${this.datosCita.cita_paciente_id}/create`,
                            this
                            .data).then((
                            res) => {
                            this.order_id =
            ...
            fetchOptometriaOrden() {
                axios.get('/api/orden/fetchOptometria/' +
                        this.datosCita.cita_paciente_id)
                    .then((res) => {
                        this.fetchOptometria = res.data;
                    });
            },

            fetchRecomendacionOrden() {
                axios.get('/api/orden/fetchRecomendacion/' +
                        this.datosCita.cita_paciente_id)
                    .then((res) => {
                        this.fetchRecomendacion = res
                            .data;
                    });
            },
            ...
            clearOptometria() {
                this.optometria.esfera_od = "",
                    this.optometria.esfera_oi = "",
                    this.optometria.esfera_od = "",
                    this.optometria.esfera_oi = "",
                    this.optometria.cilindro_od = "",
                    this.optometria.cilindro_oi = "",
                    this.optometria.eje_od = "",
                    this.optometria.eje_oi = "",
                    this.optometria.adicion_od = "",
                    this.optometria.adicion_oi = "",
                    this.optometria.prisma_od = "",
                    this.optometria.prisma_oi = "",
                    this.optometria.grados_od = "",
                    this.optometria.grados_oi = "",
                    this.optometria.lejos_od = "",
                    this.optometria.lejos_oi = "",
                    this.optometria.cerca_od = "",
                    this.optometria.cerca_oi = "",
                    this.optometria.tipo_lente = "",
                    this.optometria.detalle = "",
                    this.optometria.altura = "",
                    this.optometria.color = "",
                    this.optometria.dp = "",
                    this.optometria.dispositivos = "",
                    this.optometria.control = "",
                    this.optometria.vigencia = "",
                    this.optometria.observacion = ""
            },
            clearRecomendacion() {
                this.recomendaciones.recomedacion = ""
                this.recomendaciones.FechaFinal = ""
            },

            generateRecomendacion() {
                if (this.recomendaciones.recomedacion ==
                    "" && this.recomendaciones.FechaFinal ==
                    "") {
                    swal({
                        title: "Recomendacion",
                        text: "No se puede enviar datos vacios",
                        timer: 2000,
                        icon: "error",
                        buttons: false,
                    });
                ...
                swal({
                    title: "¿Está Seguro(a)?",
                    text: "Se guardará la Recomendacion!",
                    type: "success",
                    icon: "info",
                    buttons: ["Cancelar",
                        "Confirmar"
            ...
            listarPaquetes() {
                this.preload = true;
                axios.get('/api/cups/paquetes/servicios')
                    .then(res => {
            ...
            async agregarPaquete() {
                if (this.procedimiento.paquete
                    .hasOwnProperty("id")) {
                    this.preload = true;
                    for (const s of this.procedimiento
                            .paquete.detalle_paquete) {
                        let data = {
                            Cantidad: s.cantidad,
                            cup: s.cup
                        }
                        let service = await this
                            .getDetaServicios(data);
                        if (service) {
                            this.preload = false;
                            let msg = `Existen Ordenes activas para ése procedimiento por la cantidad ${
                            service.Cantidad
                        } en la siguiente fecha ${
                            service.created_at
                        }. La cantidad máxima es de ${service.Cantidadmaxordenar}`;
                            swal({
                                title: "¿Está Seguro de añadir?",
                                text: msg,
                                type: "success",
            ...
            pushProcedimientoPaquete(item, cantidad =
                0) {
                if (parseInt(item.cup
                        .Cantidadmaxordenar) >=
                    parseInt(item.cantidad) + parseInt(
                        cantidad)) {
                    this.preload = true;
                    this.data.procedimientos.push({
                        id: item.cup.id,
                        codigo: item.cup.Codigo,
                        nombre: item.cup.Nombre,
                        auditoria: item.cup
                            .Requiere_auditoria,
