    ...
    export default {
        ...
        methods: {
            guardar() {
                ...
                axios.post('/api/adjuntoAnexo/guardar', formData)
                    .then(res => {
                        this.clearFields()
            ...
            guardarTipoAnexo() {
                this.limpiarError()
                axios.post('/api/tipoAnexo/guardar', this.tipo)
                    .then(res => {
            ...
            listarTipoAnexo() {
                axios.get('/api/tipoAnexo/listar')
                    .then((res) => {
                        this.tipoAnexos = res.data
                        console.log('holi', res.data);
