                        ...
                        <v-card-text>
                            <v-layout row wrap>
                                    <v-layout row wrap>
                                        ...
                                        <v-flex xs12 sm6 md3>
                                            <v-autocomplete v-model="formRegistro.pais_nacionalidad_id"
                                                append-icon="search" :items="paises" item-text="nombre" item-value="id"
                                                label="nacionalidad">
                                            </v-autocomplete>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                            <v-autocomplete v-model="formRegistro.pais_ocurrencia_id"
                                                append-icon="search" :items="paises" item-text="nombre" item-value="id"
                                                label="pais ocurrencia caso">
                                            </v-autocomplete>
                                        </v-flex>
                                        <v-autocomplete v-model="formRegistro.municipio_procedencia_id"
                                            append-icon="search" :items="municipios" item-text="municipio"
                                            item-value="id" label="municipio de procedencia">
                                        </v-autocomplete>
                                        <v-flex xs12 sm6 md3>
                                        ...
                                        <v-flex xs12 sm6 md3>
                                            <v-select :items="zona" label="zona" v-model="formRegistro.zona"></v-select>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                            <v-autocomplete v-model="formRegistro.ocupacion_id" append-icon="search"
                                                :items="ocupaciones" item-text="ocupacion" item-value="id"
                                                label="ocupacion paciente">
                                            </v-autocomplete>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.discapacitados"
                                                        label="discapacitados" color="red" value="x" hide-details>
                                                    </v-checkbox>
                                                ...
                                                <v-flex xs12 sm4 md3>
                                                    ...
                                                    <v-checkbox v-model="formRegistro.poblacion_infantil_ICBF"
                                                        label="poblacion_infantil_ICBF" color="pink" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.madres_comunitarias"
                                                        label="madres_comunitarias" color="success" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.desmovilizados"
                                                        label="desmovilizados" color="info" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                        ...
                                        <v-flex xs12 sm6 md3>
                                            <v-text-field label="telefono" type="number"
                                                v-model="formRegistro.telefono"></v-text-field>
                                        </v-flex>
                                        <!-- ESPACIO EXCLUSICO PARA USO DE LOS ENTES TERRITORIALES -->
                                        <v-flex xs12 sm6 md3>
                                            <v-select :items="clasificacionCaso"
                                                label="Seguimiento y clasificación final del caso"
                                                v-model="formRegistro.clasificacion_final_caso">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                            <v-select :items="sino" label="Viajó a áreas de circulación del virus?"
                                                v-model="formRegistro.Viajo_circulacion_virus">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                            <v-select :items="sino" label="El viaje fue en el territorio nacional?"
                                                v-model="formRegistro.viajo_territorio_nacional">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3 v-if="formRegistro.viajo_territorio_nacional == 'SI'">
                                            <v-autocomplete v-model="formRegistro.municipio_viajo_id"
                                                append-icon="search" :items="municipios" item-text="municipio"
                                                item-value="id" label="¿Dónde(municipio donde viajo)?">
                                            </v-autocomplete>
                                        </v-flex>
                                        <v-flex xs12 sm6 md3>
                                            <v-select :items="sino" label="El viaje fue internacional?"
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.tos" label="tos" color="red"
                                                        value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.fiebre" label="fiebre" color="red"
                                                        value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.dolor_garganta"
                                                        label="dolor_garganta" color="indigo" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.dificultad_respiratoria"
                                                        label="dificultad_respiratoria" color="indigo" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.fatiga_adinamia"
                                                        label="fatiga_adinamia" color="orange" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.rinorrea" label="rinorrea"
                                                        color="orange" value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.conjuntivitis"
                                                        label="conjuntivitis" color="primary" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.cefalea" label="cefalea"
                                                        color="pink" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.diarrea" label="diarrea"
                                                        color="success" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.perdida_de_olfato"
                                                        label="perdida_de_olfato" color="info" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.otros_sintomas"
                                                        label="otros_sintomas" color="warning" value="x" hide-details>
                                                    </v-checkbox>
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.asma" label="asma" color="red"
                                                        value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.epoc" label="epoc" color="red"
                                                        value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.diabetes" label="diabetes"
                                                        color="indigo" value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.vih" label="vih" color="indigo"
                                                        value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.enfermedad_cardiaca"
                                                        label="enfermedad_cardiaca" color="orange" value="x"
                                                        hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.cancer" label="cancer"
                                                        color="orange" value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.malnutricion" label="malnutricion"
                                                        color="primary" value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.obesidad" label="obesidad"
                                                        color="pink" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.insuficiencia_renal"
                                                        label="insuficiencia_renal" color="success" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.medicamentos_inmunosupresores"
                                                        label="medicamentos_inmunosupresores" color="info" value="x"
                                                        hide-details></v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.fumador" label="fumador"
                                                        color="success" value="x" hide-details>
                                                    </v-checkbox>
                                                ...
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.tuberculosis" label="tuberculosis"
                                                        color="success" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.otros" label="otros" color="info"
                                                        value="x" hide-details></v-checkbox>
                                        ...
                                        <v-label>DIAGNÓSTICO Y TRATAMIENTO (Si se tomó de radiografía de tórax ¿Qué
                                            hallazgo presentaron?)</v-label>
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.infiltrado_alveolar_neumonia"
                                                        label="infiltrado_alveolar_neumonia" color="red" value="x"
                                                        hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.infiltrados_intesticiales"
                                                        label="infiltrados_intesticiales" color="red" value="x"
                                                        hide-details></v-checkbox>
                                                    <v-checkbox
                                                        v-model="formRegistro.infiltrados_basales_vidrio_esmerilado"
                                                        label="infiltrados_basales_vidrio_esmerilado" color="indigo"
                                                        value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.ninguno" label="ninguno"
                                                        color="indigo" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                            </v-layout>
                                        </v-container>
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.servicio_hospitalizo"
                                                        label="Hospitalización general" color="red" value="X"
                                                        hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.uci" label="UCI"
                                                        color="indigo darken-3" value="SI" hide-details>
                                                    </v-checkbox>
                                                    <v-text-field v-if="formRegistro.uci == 'SI'"
                                                        label="Fecha de Ingreso a UCI (dd/mm/aaaa)" type="date"
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.derrame_pleural"
                                                        label="derrame_pleural" color="red" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.derrame_pericardico"
                                                        label="derrame_pericardico" color="red" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.miocarditis" label="miocarditis"
                                                        color="indigo" value="x" hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.septicemia" label="septicemia"
                                                        color="septicemia" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.falla_respiratoria"
                                                        label="falla_respiratoria" color="orange" value="x"
                                                        hide-details></v-checkbox>
                                                    <v-checkbox v-model="formRegistro.otro" label="Otro" color="orange"
                                                        value="x" hide-details></v-checkbox>
                                        ...
                                        <v-flex xs12 sm2 md2>
                                            <v-select :items="vacuna" label="Tipo de Vacuna contra Covid"
                                                v-model="formRegistro.tipo_vacuna">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm2 md2 v-if="formRegistro.tipo_vacuna != 'NINGUNA'">
                                            <v-text-field type="date" label="Primera dosis de Vacuna contra Covid"
                                                v-model="formRegistro.primera_dosis">
                                            </v-text-field>
                                        </v-flex>
                                        <v-flex xs12 sm2 md2 v-if="formRegistro.tipo_vacuna != 'NINGUNA'">
                                            <v-text-field type="date" label="Segunda dosis de Vacuna contra Covid"
                                                v-model="formRegistro.segunda_dosis">
                                            </v-text-field>
                                        </v-flex>
                                        <v-flex xs12>
                                            <v-textarea v-model="formRegistro.observacionesregistro" name="input-7-1"
                                        ...
                                        <v-container fluid>
                                            <v-layout row wrap>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.esperarencasa"
                                                        label="Se Recomienda Esperar En Casa Y Se Informa Signos Y Sintomas De Alarma"
                                                        color="black" value="x" hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.asignarconsulta"
                                                        label="Se Asignará Consulta Médica" color="red" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.seguimientotelefonico"
                                                    ...
                                                    <v-checkbox v-model="formRegistro.consultaprioritaria"
                                                        label="Se Requiere Consulta Prioritaria" color="indigo"
                                                        value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                                <v-flex xs12 sm4 md3>
                                                    <v-checkbox v-model="formRegistro.teleorientacion"
                                                        label="Teleorientación Salud Mental" color="orange" value="x"
                                                        hide-details>
                                                    </v-checkbox>
                                                    <v-checkbox v-model="formRegistro.otrasindicaciones" label="Otros"
                                                        color="green" value="x" hide-details>
                                                    </v-checkbox>
                                                </v-flex>
                                            </v-layout>
                                        </v-container>
                                        <v-flex xs12 sm2 md2>
                                            <v-select :items="sino" label="Requiere Prueba"
                                                v-model="formRegistro.requiere_prueba">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm2 md2 v-if="formRegistro.requiere_prueba == 'SI'">
                                            <v-select :items="tipoprueba" label="Tipo de prueba"
                                                v-model="formRegistro.tipo_prueba">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm2 md2 v-if="formRegistro.requiere_prueba == 'SI'">
                                            <v-select :items="modalidaprueba" label="Modalidad de la Toma de muestra"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                vacuna: ['NINGUNA', 'MODERNA', 'SINOVAC', 'PFIZER&BIONTECH', 'CENTRO GAMALEYA (SPUTNIK V)',
                    'JOHNSON&JOHNSON', 'ASTRAZENECA', 'NO SE HA APLICADO'
                ],
                destinopaciente: ['Seguimiento', 'Oximetrías', 'Hospitalización', 'Hospitalización UCI/UCE',
                    'Alta descartado', 'Alta recuperado', 'Alta fallecido'
                ],
                ...
                clasificacionCaso: ['No aplica', 'Conf. Por laboratorio', 'Conf. Clínica',
                    'Conf. Nexo epidemiológico', 'Descartado', 'Otra actualización',
                    'Descartado por Dejar en blanco'
                ],
                zona: ['Urbana', 'Rural'],
                ...
                clasificacion: ['Sospechoso', 'Probable', 'Conf. por laboratorio', 'Conf. Clínica',
                ...
                estrato: ['1', '2', '3', '4', '5', '6'],
                etnias: ['sin pertenencia étnica', 'Indígena', 'Rom, Gitano', 'Raiza', 'Palenquero',
                    'Negro, mulato afro colombiano', 'Otro'
                ],
        ...
        methods: {
            ...
            guardarRegistro() {
                ...
                //     return;
                // }
                this.formRegistro.cita_paciente_id = this.datosCita.cita_paciente_id;
                this.formRegistro.tipo_cita = this.datosCita.Tipo_agenda;
                this.formRegistro.paciente = this.datosCita.paciente_id;
                axios.post('/api/covid/registro', this.formRegistro).then(res => {
                    this.$alerSuccess(res.data.message);
                    this.clearFields();

                    EventBus.$emit("call-order", this.formRegistro.paciente);
                })
            },
            fetchCie10s() {
