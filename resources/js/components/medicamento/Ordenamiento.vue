    ...
    <v-layout row justify-center>
        <v-dialog v-model="dialog" fullscreen hide-overlay transition="dialog-bottom-transition">
            <template v-slot:activator="{ on }">
                <v-btn v-show="showBottom" color="primary" dark v-on="on">Ordenar</v-btn>
            </template>
            <v-card>

                <v-toolbar dark color="primary">
                    <v-btn icon dark @click="clearDataParents">
                        <v-icon>close</v-icon>
                    </v-btn>
                        ...
                        <v-card>
                            <v-container grid-list-xs>
                                ...
                                paciente.Primer_Nom
                                    ...
                                    0
                                    ).toUpperCase()}${paciente.Primer_Nom.slice(
                                    1
                                    )}`
                                    : ""
                            } ${
                                paciente.SegundoNom
                                    ...
                                    0
                                    ).toUpperCase()}${paciente.SegundoNom.slice(
                                    1
                                    )}`
                                    : ""
                            } ${
                                paciente.Primer_Ape
                                    ...
                                    0
                                    ).toUpperCase()}${paciente.Primer_Ape.slice(
                                    1
                                    )}`
                                    : ""
                            } ${
                                paciente.Segundo_Ape
                                    ...
                                    0
                                    ).toUpperCase()}${paciente.Segundo_Ape.slice(
                                    1
                                    )}`
                                    : ""
                            } `}}</b></span>
                                    ...
                                    <span>
                                        ...
                                        <span
                                            style="color:red"><b>{{paciente.Tipo_Doc.toUpperCase() + " " + paciente.Num_Doc}}</b></span>
                                    </span>
                                    <span>
                                        <b>Edad:</b>
                                    ...
                                    <span>
                                        ...
                                        <span style="color:red" v-if="paciente.Ut == 'MEDIMAS'">
                                            <b>{{paciente.tipo_categoria}}</b>
                                        </span>
                                    </span>
                                    <span v-show="paciente.Ut == 'MEDIMAS'">
                                        <b>Nivel:</b>
                    ...
                    <v-card>
                        <v-container grid-list-xs>
                            <v-layout row wrap>
                                ...
                                <v-form>
                                    <v-flex xs12>
                                        <VAutocomplete label="Tipo ordenamiento" :items="tipoOrdenamiento"
                                            item-value="id" item-text="Nombre" v-model="data.Tiporden_id"
                                            @input="tipoOrdenSelected()" />
                                    </v-flex>
                                </v-form>
                                <template
                                                ...
                                                <v-container grid-list-md>
                                                    ...
                                                    " lazy transition="scale-transition" offset-y full-width
                                                        ...
                                                        ">
                                                            ...
                                                            <VTextField v-else label="Fecha Inicio" readonly
                                                                :type="'label'" @input="getFinalDate()" v-model="
                                                        incapacidad.FechaInicio
                                                    " required />
                                                        </v-flex>
                                                        <v-flex xs1>
                                                    ...
                                                    " required />
                                                        ...
                                                        <v-flex xs3>
                                                            <VTextField label="Fecha Final" readonly :type="'label'"
                                                                v-model="
                                                    ...
                                                    " :loading="loading" :search-input.sync="search" />
                                                        ...
                                                        <v-flex xs12 lg12>
                                                            <VTextarea name="input-7-1"
                                                                label="Descripción de incapacidad" value v-model="
                                ...
                                <template v-if="data.Tiporden_id == 3">
                                    <v-flex xs12>
                                        <v-layout row wrap>
                                            ...
                                            <v-flex xs2>
                                                <v-select v-model="articulos.NumMeses" label="Número meses"
                                                    :items="meses" item-text="accion" item-value="value" hide-details>
                                                </v-select>
                                            </v-flex>
                                            <v-flex xs1>
                                            ...
                                            <v-flex xs2 v-else>
                                                <v-text-field type="number" min="1"
                                                    onkeypress="return event.charCode >= 48" oncopy="return false"
                                                    onpaste="return false" v-model="articulos.Cantidadpormedico"
                                                    label="Cantidad mensual médico"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4>
                                                <v-text-field v-model="articulos.Observacion" label="Observación">
                                                </v-text-field>
                                            </v-flex>
                                        </v-layout>
                                ...
                                <template v-if="data.Tiporden_id == 2 || data.Tiporden_id == 4">
                                    <v-flex xs12>
                                        <v-layout row wrap>
                                            ...
                                            <v-flex xs1>
                                                <v-text-field label="cantidad" v-model="procedimiento.cantidad">
                                                </v-text-field>
                                            </v-flex>
                                            <v-flex xs2>
                                                <v-menu v-model="menu1" :close-on-content-click="false"
                                                    ...
                                                    <template v-slot:activator="{ on }">
                                                        <v-text-field v-model="procedimiento.date" label="Vigente desde"
                                                            prepend-icon="event" readonly persistent-hint
                                                            hint="formato YYYY-MM-DD" v-on="on"></v-text-field>
                                                    </template>
                                                    <v-date-picker v-model="procedimiento.date" locale="es"
                                                        color="primary" @input="menu1 = false" :min="startDate">
                                                    </v-date-picker>
                                                </v-menu>
                                            </v-flex>
                                            <v-flex xs4>
                                ...
                                <template v-if="data.Tiporden_id == 6">
                                    <v-flex xs12>
                                        <v-layout row wrap>
                                            <v-flex xs11>
                                                <VAutocomplete label="Servicios Propios"
                                                    :items="filteredServiciosPropios" item-text="full_name"
                                                    v-model="servicioPropio.service" return-object />
                                            </v-flex>
                                            <v-flex xs1>
                                ...
                                <template v-if="data.Tiporden_id == 7 && articulosOrdered.length === 0">
                                    <v-flex xs12>
                                        <v-layout row wrap>
                                            <v-flex xs12>
                                                <VAutocomplete label="Esquemas" :items="esquemas" item-text="fullName"
                                                    return-object v-model="esquema" @change="fetchCodeSumiEsquema" />
                                            </v-flex>
                                            <v-flex xs1>
                                                <v-text-field name="name" label="Ciclo inicial"
                                                    v-model="esquema.cycleFrom" />
                                            </v-flex>
                                            <v-flex xs1>
                            ...
                            <v-layout row wrap v-show="data.Tiporden_id != 1">
                                <v-flex xs12>
                                    <!--tipo orden 3-->
                                    <v-data-table v-show="data.Tiporden_id == 3" :headers="headers"
                                        :items="data.articulos" hide-actions class="elevation-1"
                                        ...
                                        <template v-slot:items="props">
                                            ...
                                            <td class="text-xs-center">
                                                {{ props.item.Cantidadpormedico }}
                                            </td>
                                            <td class="text-xs-center">
                                                {{ props.item.Observacion }}
                                            </td>
                                            <td class="text-xs-center">
                                                {{ props.item.Requiere_autorizacion }}
                                            </td>
                                            <td class="text-xs-center">
                                    ...
                                    <v-data-table v-show="data.Tiporden_id == 6" :headers="headersProcedimientos"
                                        :items="data.serviciosPropios" hide-actions class="elevation-1"
                                        pagination.sync="pagination" item-key="id" loading="true">
                                        <template v-slot:items="props">
                                            <td class="text-xs-center">
                                                {{ props.item.codigo }}
                                    ...
                                    <!--tipo orden 2 o 4-->
                                    <v-data-table v-show="
                                data.Tiporden_id == 2 || data.Tiporden_id == 4
                            " :headers="headersProcedimientos" :items="data.procedimientos" hide-actions
                                    ...
                                    <v-data-table v-model="data.codeSumiEsquemaSelected" v-show="data.Tiporden_id == 7"
                                        :headers="headersEsquemasTable" :items="mapDetailScheme" hide-actions
                                        class="elevation-1" pagination.sync="pagination" item-key="id" select-all
                                        loading="true">
                                        <template v-slot:headers="props">
                                            <tr>
                                                <th>
                                                    <VCheckbox color="primary" :input-value="props.all"
                                                        :indeterminate="props.indeterminate" hide-details
                                        ...
                                        ">
                                                    <VCheckbox color="primary" :input-value="props.selected" primary
                                                        hide-details />
                                                </td>
                                                <td class="text-xs-center">
                                                    {{ props.item.Codigo }} -
                                            ...
                                            " lazy>
                                                        ...
                                                        <template v-slot:input>
                                                            <VTextField single-line v-model="props.item.dosis" />
                                                        </template>
                                                    </v-edit-dialog>
                                                </td>

                                                <td class="text-xs-center">
                                                    {{ props.item.indiceDosis }}
                                                    {{ bodySurfaceIndex }}
                                                </td>
                                                <td class="text-xs-center">
                                                    <v-edit-dialog :return-value.sync="
                                ...
                                <v-layout row wrap>
                                    <VSpacer />
                                    <v-btn color="dark" round :loading="ordering" @click="generateOrder()">
                                        Ordenar
                                    </v-btn>
                                </v-layout>
                            </v-layout>
                        ...
                        <v-card>
                            <v-container grid-list-xs>
                                <v-layout row wrap>
                                    <v-flex xs12>
                                        <!--tipo orden 1-->
                                        <v-data-table v-show="data.Tiporden_id == 1"
                                            :headers="headersIncapacidadesOrdered" :items="incapacidadOrdered"
                                            hide-actions class="elevation-1" pagination.sync="pagination" item-key="id"
                                            loading="true">
                                            <template v-slot:items="props">
                                                <td class="text-xs-center">
                                                ...
                                                <td class="text-xs-center">
                                                    {{ props.item.Fechafinal }}
                                                </td>
                                                <td class="text-xs-center">
                                                    {{ props.item.Prorroga }}
                                                </td>
                                                <td class="text-xs-center">
                                                    {{ props.item.Contingencia }}
                                                </td>
                                            </template>
                                            <v-alert v-slot:no-data :value="true" color="error" icon="warning">No hay
                                                datos.
                                            </v-alert>
                                        </v-data-table>
                                        <!--tipo orden 3 o 7-->
                                        <v-data-table v-show="data.Tiporden_id == 3" :headers="headersArticulosOrdered"
                                            :items="articulosOrdered" hide-actions class="elevation-1"
                                            pagination.sync="pagination" item-key="id" loading="true">
                                            <template v-slot:items="props">
                                                <td class="text-xs-center">
                                                    {{ props.item.nombre }}
                                                ...
                                                <td class="text-xs-center">
                                                    <v-chip color="primary" v-show="props.item.mipres"
                                                        text-color="white">MIPRES</v-chip>
                                                </td>
                                                <!-- <td class="text-xs-center">
                                                          <v-btn color="error" @click="removeArticulo(props)" icon>
                                                              <v-icon>clear</v-icon>
                                        ...
                                        <!--tipo orden 2 o 4-->
                                        <v-data-table v-show="data.Tiporden_id == 2 || data.Tiporden_id == 4" :headers="headersProcedimientosOrdered" :items="cupsOrdered" hide-actions
                                            ...
                                            <template v-slot:items="props">
                                                ...
                                                <td class="text-xs-center">
                                                    {{
                                            props.item.created_at.substring(
                                                0,
                                                10
                                            )
                                        }}
                                                ...
                                                <td class="text-xs-center">
                                                    <v-chip color="primary" v-show="props.item.anexo3"
                                                        text-color="white">ANEXO 3</v-chip>
                                                </td>
                                            </template>
                                            <v-alert v-slot:no-data :value="true" color="error" icon="warning">No hay
                                                datos.
                                        ...
                                        <!--tipo orden 6-->
                                        <v-data-table v-show="data.Tiporden_id == 6"
                                            :headers="headersProcedimientosOrdered" :items="serviciosPropiosOrdered"
                                            hide-actions class="elevation-1" pagination.sync="pagination" item-key="id"
                                            loading="true">
                                            <template v-slot:items="props">
                                                <td class="text-xs-center">
                                        ...
                                        <v-card-text v-show="data.Tiporden_id == 7">
                                            <v-layout row wrap>
                                                <v-flex xs12>
                                                    <span><b>Nombre esquema:</b>
                                                        {{ infoOrder.scheme_name }}</span><br />
                                                    <span><b>Número ciclo:</b>
                                                        {{ infoOrder.page }}</span><br />
                                                    <span><b>Total número ciclo:</b>
                                                        {{ infoOrder.total_pages }}</span>
                                                </v-flex>
                                            </v-layout>
                                        </v-card-text>
                                    ...
                                    articulosOrdered.length > 0 &&
                                        data.Tiporden_id == 7
                                " @click="cancelOrderOncologica()">
                                            Cancelar
                                        </v-btn>
                                        <VSpacer />
                                        <v-btn color="dark" round v-show="(path == '/transcripcion' || path.includes('historiaclinica') || path == '/referencia/alta') && paciente.tipo_categoria != 'POS'
                                " @click="printPDF()">
                                            Imprimir
                                        </v-btn>
                                    </v-layout>
        ...
        filters: {
            PosViaAdmin: item => {
                if (item.Unidadtiempo == "Horas")
                    return `${item.Cantidadosis} ${item.Unidadmedida} ${
                    item.Via
                } cada ${item.Frecuencia} Horas por ${item.Duracion} días`;
                else
                    return `${item.Cantidadosis} ${item.Unidadmedida} ${
                    item.Via
                } cada
        ...
        computed: {
            cantidadMensual() {
                if (this.articulos.Unidadtiempo == "Horas") {
                    ...
                    this.articulos.Cantidadmensual = Math.round(
                        (this.articulos.Duracion / this.articulos.Frecuencia) *
                        this.articulos.Cantidadosis
                    );
                }
            ...
            filteredMedicamentos() {
                let less = this.articulosOrdered.map(
                    articulo => articulo.codesumi_id
                );
                less = less.concat(
                    this.data.articulos.map(articulo => articulo.id)
                );
            ...
            filteredServiciosPropios() {
                let less = this.serviciosPropiosOrdered.map(
                    serv => serv.Serviciopropio_id
                );
                less = less.concat(this.data.serviciosPropios.map(serv => serv.id));
                return this.serviciosPropios
                    .filter(servicio => {
            ...
            mapDetailScheme() {
                return this.codeSumiEsquema.map(detail => {
                    if (detail.frecuenciaDuracion) {
                        ...
                        detail.frecuenciaDuracion[
                            detail.frecuenciaDuracion.length - 1
                        ] = detail.diasAplicacion;
        ...
        methods: {
            addArticulo: async function () {
                if (
                    ...
                    let medicamento = await this.getDetaMedicamentos(
                        this.articulos
                    );

                    if (medicamento) {
                        let msg = `Existen Ordenes activas para ése medicamento por la cantidad ${
                        medicamento.Cantidadpormedico
                    } en la siguiente fecha ${
                        medicamento.Fechaorden
                    }. La cantidad máxima es de ${
                        medicamento.Cantidadmaxordenar
                    }`;
                        swal({
                            title: "Error",
                            text: msg,
            ...
            addservicioPropio: async function () {
                if (
                    this.servicioPropio.service.hasOwnProperty("id") &&
                    this.servicioPropio.cantidad > 0
                ) {
                    let service = await this.getDetaServiciosPropios(
                        this.servicioPropio
                    );
                    if (service) {
                        let msg = `Existen Ordenes activas para ése servicio por la cantidad ${
                        service.Cantidad
                    } en la siguiente fecha ${
                        service.created_at
                    }. La cantidad máxima es de ${service.Cantidadmaxordenar}`;
            ...
            cancelOrderOncologica: async function () {
                try {
                    let isSure = await this.$alertQuestion(
                        "¿Segur@ que desea cancelar este esquema?"
                    );
                    if (isSure.value) {
                        let {
                            data
                        } = await axios.post(
                            `/api/orden/cancelEsquema/${
                            this.articulosOrdered[0].Orden_id
                        }`
                        );
                        this.infoOrder = {};
            ...
            fetchBodySurfaceIndex: async function () {
                await axios
                    .get(
                        `/api/historiapaciente/${this.cita_paciente}/examen_fisico`
                    )
                    .then(res => {
            ...
            dosisFormuladaCalculate(detail) {
                if (detail.indiceDosis === "ISC")
                    detail.dosisFormulada = (
                        detail.dosis * this.bodySurfaceIndex
                    ).toFixed(1);
            ...
            fetchCodeSumiEsquema: async function () {
                try {
                    ...
                    this.codeSumiEsquema = await CodeSumiService.getCodeSumiEsquemas(
                        this.esquema.id
                    );
                    this.data.codeSumiEsquemaSelected = this.codeSumiEsquema.map(
                        detail => {
                            if (detail.indiceDosis === "ISC")
                                detail.dosisFormulada = (
                                    detail.dosis * this.bodySurfaceIndex
            ...
            fetchCupsInterconsultas: async function () {
                await axios
                    .get("/api/cups/interconsultas/" + this.cita_paciente)
                    .then(res => {
                        this.cups = res.data;
                    });
            },
            ...
            fetchEnableEsquemasOrdered: async function () {
                await axios
                    .get(`/api/orden/getOrderedScheme/${this.cita_paciente}`)
                    .then(res => {
                        this.articulosOrdered = [];
                        if (res.data.hasOwnProperty("id")) {
                            this.articulosOrdered = res.data.detaarticulordens.map(
                                art => art
                            );
                        } else if (res.data.length > 0) {
                            res.data.forEach(data => {
                                let detailItems = data.detaarticulordens.map(
                                    art => art
                                );
                                detailItems.forEach(detailItem => {
                                    let found = this.articulosOrdered.find(
                                        articulo =>
                                        articulo.codesumi_id ==
                                        detailItem.codesumi_id
                                    );
                                    if (!found)
                                        this.articulosOrdered.push(detailItem);
                                });
                            });
                            this.infoOrder = {
            ...
            fetchColegios() {
                this.loading = true;
                axios
                    .post("/api/colegio/getColegioByName", {
                        nombre: this.search
                    })
                    .then(res => {
            ...
            fetchIncOrdenred() {
                axios
                    .get(`/api/orden/getOrderedCie/${this.cita_paciente}`)
                    .then(res => {
            ...
            fetchServiciosPropiosOrdered() {
                axios
                    .post(
                        `/api/orden/getOrderedServicioPropio/${this.cita_paciente}`, {
                            Tiporden_id: this.data.Tiporden_id
                        }
                    )
                    .then(res => {
                        ...
                        if (res.data.length > 0)
                            this.order_id = this.serviciosPropiosOrdered[0].hasOwnProperty(
                                "Orden_id"
                            ) ?
                            this.serviciosPropiosOrdered[0].Orden_id :
                            null;
            ...
            generateInc() {
                ...
                if (this.paciente.Ut === 'REDVITAL UT' && this.incapacidad.Colegio == null) {
                    swal({
                        title: "Por favor ingrese una colegio!",
                        text: "Incapacidad",
                        timer: 2000,
                        icon: "error",
                        buttons: false
            ...
            getFinalDate() {
                ...
                if (
                    ...
                    this.incapacidad.CantidadDias > 30
                ) {
                    swal({
                        title: "Incapacidad",
                ...
                if (this.enable == true) {
                    this.incapacidad.FechaFinal = moment(
                            this.incapacidad.FechaInicio
                        )
            ...
            getPosViaAdmin(medicamento) {
                if (medicamento.Unidadtiempo == "Horas")
                    return `${medicamento.Cantidadosis} ${
                    medicamento.Unidadmedida
                } ${medicamento.Via} cada ${medicamento.Frecuencia} Horas X ${
            ...
            getCupOrden: async function () {
                ...
                this.cupsOrdered.forEach(procedimiento => {
                    if (
                        procedimiento.Estado_id != 15 &&
                        procedimiento.created_at.substring(0, 10) ==
            ...
            getConducta() {
                axios
                    .post(`/api/conducta/${this.cita_paciente}/getConductaByCita`)
                    .then(res => {
            ...
            getDetaMedicamentos: async function (articulo) {
                ...
                await axios
                    .post("/api/orden/getDetaArticuloOrden", {
            ...
            getDetaServiciosPropios: async function (service) {
                ...
                await axios
                    .post("/api/orden/getServicioPropio", {
            ...
            printPDF: async function () {
                if (
                    this.articulosOrdered.length == 0 &&
                    this.cupsOrdered.length == 0 &&
                    this.servicioPropio.length == 0 &&
                    this.data.Tiporden_id != 1
                ) {
                    swal({
                        title: "Impresión",
                    ...
                    this.data.Tiporden_id == 1 &&
                    this.incapacidadOrdered.length == 0
                ) {
                    swal({
                        title: "Impresión",
                    ...
                    switch (this.data.Tiporden_id) {
                        ...
                        case 3:
                            await axios
                                .get(`/api/orden/getOrderedCodesumi/${this.cita_paciente}`).then(res => {
                                    res.data.forEach(data => {
                                        let obj = {
                                            Num_Doc: this.paciente.Num_Doc,
                                            type: 'formula',
                        ...
                        case 4:
                            ...
                            this.serviciosByNo.forEach(ser => {
                                if (!printPagesCup.hasOwnProperty(ser.Ubicacion_id))
                                    printPagesCup[ser.Ubicacion_id] = [];
                        ...
                        case 6:
                            ...
                            this.servicioPropioByNo.forEach(ser => {
                                if (
                                    !printPagesService.hasOwnProperty(
                                        ser.Ubicacion_id
                                    )
                                )
                                    printPagesService[ser.Ubicacion_id] = [];
            ...
            pushProcedimiento(cantidad = 0) {
                if (
                    parseInt(this.procedimiento.cup.Cantidadmaxordenar) >=
                    parseInt(this.procedimiento.cantidad) + parseInt(cantidad)
                ) {
            ...
            pushServicioPropio(cantidad = 0) {
                if (
                    parseInt(this.servicioPropio.service.Cantidadmaxordenar) >=
                    parseInt(this.servicioPropio.cantidad) + parseInt(cantidad)
                ) {
                    this.data.serviciosPropios.push({
                        ...
                        auditoria: this.servicioPropio.service
                            .Requiere_autorizacion,
                        nivelordenamiento: this.servicioPropio.service
                            .Nivel_ordenamiento,
            ...
            toggleAll() {
                if (this.data.codeSumiEsquemaSelected.length)
                    ...
                    this.data.codeSumiEsquemaSelected = this.codeSumiEsquema.slice();
            },
