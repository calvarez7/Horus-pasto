<template>
    <v-container pa-1>
        ...
        <v-card-title>
            <v-btn v-if="can('sede.create')" round @click="createSede()"  color="primary" dark><v-icon left>person_add</v-icon>Nueva Sede</v-btn>
        <v-spacer></v-spacer>
        <v-flex
         xs1
         sm5
        ...
        <v-data-table
            ...
            <tr @click="expandTable(props)">
                ...
                <td class="text-xs-right">
                    <v-btn v-if="can('sede.edit')" fab outline color="warning" small @click="editSede(props.item)"><v-icon>edit</v-icon></v-btn>
                    <v-btn v-if="can('consultorio.create')" fab outline color="success" small @click="createConsultorio(props)" ><v-icon>add</v-icon></v-btn>
                </td>
            </tr>
            </template>
                ...
                <v-data-table
                 ...
                 >
                    <template v-slot:items="props">
                        ...
                        <td class="text-xs-right">
                            <v-btn v-if="can('consultorio.edit')" fab color="warning" small @click="editConsultorio(props.item)"><v-icon>edit</v-icon></v-btn>
                        </td>
                    </template>
