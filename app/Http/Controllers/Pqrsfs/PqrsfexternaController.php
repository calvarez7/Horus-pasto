...
class PqrsfexternaController extends Controller
{
    ...
    public function slope(Request $request)
    {
        $pqrsfs = Pqrsf::select(['Pqrsfs.Email', 'Pqrsfs.Afec_numdoc as doc','Pqrsfs.Canal',
            ...
            'pqrsfs.Atr_calidad', 'pqrsfs.Tiposolicitud', 'Pacientes.id as Paciente_id', 'Pacientes.Edad_Cumplida','Pqrsfs.Pqr_codigo',
            ...
            ->where('Pqrsfs.Canal', $request->canal)
    ...
    public function pre_solution(Request $request){
    ...
    public function countPqrsfs(Request $request)
    {
        if(isset($request->canal)){
            $pendientes = Pqrsf::where('Estado_id', 18)->where('Canal', $request->canal)->count();
            $asignadas = Pqrsf::whereIn('Estado_id', [5, 24, 11])->where('Canal', $request->canal)->count();
            $pre_solucionadas = Pqrsf::where('Estado_id', 19)->where('Canal', $request->canal)->count();
            $solucionadas = Pqrsf::whereIn('Estado_id', [13, 26])->where('Canal', $request->canal)->count();
        }else{
            $pendientes =  Pqrsf::where('Estado_id', 18)->whereIn('Canal', ['Web', 'Supersalud'])->count();
            $asignadas =  Pqrsf::whereIn('Estado_id', [5, 24, 11])->whereIn('Canal', ['Web', 'Supersalud'])->count();
            $pre_solucionadas = Pqrsf::where('Estado_id', 19)->whereIn('Canal', ['Web', 'Supersalud'])->count();
            $solucionadas = Pqrsf::whereIn('Estado_id', [13, 26])->whereIn('Canal', ['Web', 'Supersalud'])->count();
        }
